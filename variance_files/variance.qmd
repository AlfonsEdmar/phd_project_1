...
Similarly, Weiss 2014 provides a similar but slightly different view of how to evaluate heterogeneity in the effect of programs. They, like Cochrane argue that heterogeneity has tree sources: Treatment contrast, within participants moderators, and contextual moderators.
...
It is important to note that the contexts of these perspectives on heterogeneity differs, one is from medicin and the other from political science and policy. However, they both have striking similarities. The main difference is that Cochrane places less weight on stimuli strength, which presumably would fall into methodological heterogeneity.
